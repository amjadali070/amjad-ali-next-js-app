import {
  SiJavascript, SiTypescript, SiPython, SiCplusplus, SiSolidity, SiReact, SiNextdotjs,
  SiHtml5, SiCss3, SiTailwindcss, SiChakraui, SiNodedotjs, SiExpress, SiMongodb,
  SiMysql, SiPostgresql, SiFirebase, SiTensorflow, SiKeras, SiScikitlearn, SiOpencv,
  SiPytorch, SiOpenai, SiGit, SiDocker, SiKubernetes, SiGooglecloud, SiSupabase,
  SiPrisma, SiJenkins, SiGithubcopilot, SiNestjs, SiGraphql, SiApollographql,
  SiSocketdotio, SiRedux, SiReactquery, SiFramer, SiVite, SiStorybook, SiReacthookform,
  SiHuggingface, SiGithubactions, SiVercel, SiNetlify, SiTerraform, SiCloudflare,
  SiRedis, SiNginx, SiApachekafka, SiSqlite, SiJest, SiCypress, SiTestinglibrary,
  SiAndroidstudio, SiEclipseide, SiApache, SiJupyter, SiGooglecolab, 
  SiIntellijidea, SiPycharm, SiWebstorm, SiSublimetext
} from "react-icons/si";
...
export const projects = [
  {
    ...
    description: "Built a feature-rich CRM platform with contact management, sales tracking, and customer support integration. Implemented analytics and reporting modules for real-time insights.",
    image: CRMThumbnail,
  ...
  },
  {
    ...
    description: "Developed a comprehensive HRM system with features including attendance tracking, leave management, and payroll processing. Designed a user-friendly dashboard to streamline HR tasks and improve operational efficiency.",
    image: HRMThumbnail,
  ...
  },
  {
    ...
    description: "Built a finance dashboard that shows predictions and budget advice using AI. Integrated ChatGPT to answer financial questions interactively.",
    image: AIDBThumbnail,
  ...
  },
  {
    ...
    description: "Created a dashboard to monitor live data and performance metrics. Used charts and graphs to visualize trends in real-time.",
    image: AIDBThumbnail,
    link: "#",
  ...
  },
  {
    ...
    description: "Developed a secure voting app using Ethereum smart contracts. Ensured transparent vote recording and result validation.",
    image: AIDBThumbnail,
    link: "#",
  ...
  },
  {
    ...
    description: "Built a drag-and-drop tool for users to design and publish websites. Supported live preview and responsive templates for easy customization.",
...
export const skillsData = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "React Hook Form", icon: <SiReacthookform />, color: "text-rose-400" },
    ],
  },
  {
    category: "Back-End",
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Hugging Face", icon: <SiHuggingface />, color: "text-yellow-300" },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Antigravity", icon: <FaSpaceShuttle />, color: "text-orange-500" },
      ...
      { name: "Sublime Text", icon: <SiSublimetext />, color: "text-orange-500" },
    ],
  },
  {
    category: "Others",
...
export const certificationsData = [
  ...
  },
  {
    ...
    skills: ["GitHub", "SASS", "AWS", "CSS", "Version Control", "Git", "HTML5", "Node.js", "REST APIs", "Web Technologies"],
  },
  {
