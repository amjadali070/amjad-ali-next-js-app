    ...
    <nav className={`fixed top-0 left-0 w-full z-50 smooth-transition ${
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className={`md:hidden overflow-hidden smooth-transition ${
          ...
          <div className="hidden 2xl:flex items-center space-x-1">
            {navLinks.map((link) => (
              <Link
                ...
                href={link.path}
                onClick={() => handleLinkClick(link.label)}
                className={`group relative flex items-center space-x-1 px-2 py-2 rounded-xl 
                  smooth-transition font-medium text-xs ${
                  activeLink === link.label
          ...
          {/* Compact Desktop Navigation for xl screens */}
          <div className="hidden xl:flex 2xl:hidden items-center space-x-1">
            ...
            <div className="relative group">
              <button className="flex items-center justify-center w-9 h-9 rounded-xl text-slate-300 hover:text-white hover:bg-white/5 smooth-transition">
                <HiMenu className="text-base" />
              </button>
              
              {/* Dropdown menu */}
              <div className="absolute top-full right-0 mt-2 w-48 glass rounded-2xl p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible smooth-transition">
          ...
          <div className="hidden lg:block">
            <Link
              href="/#contact"
              className="group relative overflow-hidden px-4 py-2 bg-gradient-to-r 
                from-purple-500 to-cyan-500 rounded-xl text-white font-semibold 
                shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 
                smooth-transition transform hover:scale-105 text-sm"
            >
        ...
        <div className={`lg:hidden overflow-hidden smooth-transition ${
          ...
          <div className="glass rounded-2xl p-6 space-y-2 max-h-96 overflow-y-auto">
            {navLinks.map((link) => (
              <Link
                key={link.label}
                href={link.path}
