...
const HeroGraphic = () => (
  <div className="relative w-full h-full flex items-center justify-center">
    <div className="relative w-[300px] h-[300px] md:w-[450px] md:h-[450px]">
       ...
       <div className="absolute inset-0 m-auto w-32 h-32 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full blur-xl animate-pulse" />
       <div className="absolute inset-0 m-auto w-24 h-24 bg-surface border border-white/10 rounded-full flex items-center justify-center backdrop-blur-md shadow-[0_0_30px_rgba(79,195,247,0.2)]">
  ...
  return (
    <div className="min-h-screen bg-background text-text selection:bg-primary/20 selection:text-primary">
      ...
      <main className="flex flex-col">
        {/* Hero Section */}
        <section id="home" className="relative pt-24 min-h-screen flex flex-col justify-center overflow-hidden">
            ...
            <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-8 items-center relative z-10">
                <div className="order-2 lg:order-1 space-y-6">
                    ...
                    >
                        <span className="block text-text">Amjad A<span className="text-primary">.</span></span>
